          ...
          <Card className="p-8 shadow-soft border-2 space-y-8">
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                Contact us at hello@ilogicsystems.example to exercise these rights.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                For questions about this privacy policy, please contact us at hello@ilogicsystems.example
              </p>
            </section>
          </Card>
        </div>
